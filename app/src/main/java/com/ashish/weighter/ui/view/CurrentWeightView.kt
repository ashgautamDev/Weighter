...
fun CurrentWeightInfoView(currentWeight: String , modifier: Modifier) {
    ...
    Column(modifier = modifier.background(color = background).fillMaxWidth()) {
        Text(text = "current Weight".uppercase(), color = textDark , fontSize = 8.sp , fontWeight = FontWeight.Bold)
